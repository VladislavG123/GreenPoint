...
namespace GreenPoint.Dotnet.DataAccess.Migrations
{
    ...
    [Migration("20210421030316_EmailAdded")]
            ...
            modelBuilder.Entity("GreenPoint.Dotnet.DataAccess.Models.Admin", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("ccbf4ecb-22bc-4579-af92-ad612cc04f21"),
                            CreationDate = new DateTime(2021, 4, 21, 9, 3, 15, 156, DateTimeKind.Local).AddTicks(1887),
                            Login = "dev",
                            Password = "$2b$10$L03NivVaAFvIOaeU/JoOMurJxv8Ipw0FuXi1I8ukuzq/5JqOciU3O"
                        });
                });
